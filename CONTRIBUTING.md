...
``` git clone git@github.com:your-username/harbor```
3. Make your changes! :tada:
4. Push to your fork and ![submit a pull request](https://github.com/SalvatoreTosti/harbor/compare "submit a pull request")
